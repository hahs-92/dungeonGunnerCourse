...
public class RoomTemplateSO : ScriptableObject
{
    ...
    // this is used to regenerate the guide if the so is copied and the prefab is changed
    [HideInInspector]
    ...
    #region Tooltip
    [Tooltip("The room node type SO. The room node type correspond to the rrom nodes used in the room node graph. The exceptions being with corridors." +
    ...
    [Tooltip("If you imagine a rectangle around the room tilemap that just completely encloses it, " +
        "the room lower bounds represent the bottom right corner of that rectangle. " +
        "This should be determined from the tilemap for the room (using the coordinate brush pointer to get the tilemap grid position for that bottom right corner " +

...
public class FireWeapon : MonoBehaviour
{
    ...
    private void WeaponShootEffect(float aimAngle)
    {
        ...
        if (
            activeWeapon.GetCurrentWeapon().weaponDetails.weaponShootEffect != null &&
        ...
        )
        {
            ...
            WeaponShootEffect weaponShootEffect = (WeaponShootEffect)PoolManager.Instance.
                ReuseComponent(activeWeapon.GetCurrentWeapon().weaponDetails.weaponShootEffect.weaponShootEffectPrefab, activeWeapon.GetShootEffectPosition(), Quaternion.identity);
